...
DEBUG = False
PC_IS_POWERFUL = False  # unfortunately
...
SYMBOLS_SPEED = 15  # from 0 to infinity
SYMBOLS_SPEED_ADDITION = 4   # from 0 to infinity
...
EVENTS_FREQUENCY = 0.05  # from 0 to 1


def get_random_symbol_size():
    if random.random() < (0.7 if PC_IS_POWERFUL else 0.2):
